-- ============================================================================
-- SIMPLE WORKING SOLUTION (TYPE CORRECTED)
-- ============================================================================
-- This creates a minimal, working posts API with correct types
-- ============================================================================

-- 1. CREATE SIMPLE POSTS FUNCTION WITH CORRECT TYPES
...
BEGIN
  ...
  -- Calculate total pages as integer
  total_pages_val := CEIL(total_posts::FLOAT / limit_param);
  ...
  -- Return results with correct types
  RETURN QUERY SELECT 
...
-- 3. TEST THE FUNCTION
SELECT 'Testing corrected function:' as test_type;
SELECT * FROM public.get_public_posts(1, 12, 'all') LIMIT 1;

SELECT 'Simple working solution (type corrected) created successfully' as final_status;
