    ...
    <main className="container mx-auto p-4 max-w-4xl">
      ...
      <div className="mt-12 text-center bg-gray-50 rounded-lg p-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 max-w-2xl mx-auto">
          <h3 className="text-lg font-semibold mb-4 text-gray-900">Get in Touch Directly</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">citymaid60@gmail.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="text-blue-600">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">+977 9841317273</p>
                </div>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Talchhikhel 15, Satdobato</p>
                  <p className="text-gray-600 text-sm">Lalitpur, Nepal</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="text-blue-600">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Sun-Fri: 9AM - 5PM</p>
                </div>
              </div>
            </div>
          </div>
